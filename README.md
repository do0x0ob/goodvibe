...
基於 Stable Layer 的 DeFi 公益募資平台。用戶持有品牌穩定幣（資產留在自己錢包），透過「支持」登記要贊助的項目與金額，等同捐贈穩定幣存款收益做公益，同時保持資金流動性。收益由項目方 claim，合約僅記錄支持關係與接收捐贈，不託管用戶資產。Project manager 可更新進度、導出目前捐贈者列表，供後續福利發放（如 NFT、空投）依據。
